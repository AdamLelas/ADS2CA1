...
private:
	...
	void makeQueue(Node* passedNode, double maxDist, City cityin, priority_queue<pair<string, double>>& pq); //makes the priority queue for displayInDist
	...
	void displayQueue(priority_queue<pair<string, double>>& pq);
